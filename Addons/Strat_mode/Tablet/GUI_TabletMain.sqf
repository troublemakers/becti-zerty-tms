...
while { true } do {
	...
	if !(CTI_Base_ControlCenterInRange && Client_AN_Connected) then {
		{((uiNamespace getVariable "cti_dialog_ui_tabletmain") displayCtrl _x) ctrlEnable false} forEach [210003,210004,210005,210008,210009,210010,210011];
	} else {
		{((uiNamespace getVariable "cti_dialog_ui_tabletmain") displayCtrl _x) ctrlEnable true} forEach [210003,210004,210005,210008,210009,210010,210011];
	};
