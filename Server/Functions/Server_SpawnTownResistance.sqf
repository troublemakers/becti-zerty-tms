...
switch (true) do {
	...
	case (_value > 450) : {
		...
		[["GUER_VEHICLES_LIGHT", 1, 27], ["GUER_VEHICLES_MEDIUM", 2, 45], ["GUER_VEHICLES_ARMORED_LIGHT", 1, 43], ["GUER_VEHICLES_HEAVY", 1, 42], ["GUER_VEHICLES_AA_LIGHT", 1, 30]]
		];
	};
};
