...
while {(_eastLocation distance _westLocation) <(_asked) ||(_eastLocation distance _westLocation) >( _asked)+5 || {(_x distance _eastLocation)<600} count CTI_Towns>0 || {(_x distance _westLocation)<600} count CTI_Towns>0} do {
