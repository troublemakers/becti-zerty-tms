...
<t size='1.4' color='#2394ef'>Interactions</t><br />
You can open the interraction menu if you are close enougth by pressing the <t color='#2394ef'>%1 key</t>.<br />
...
This menu will differ if you are inside a vahicle or outside and also on what kind of object you are looking at.",keyImage(profilenamespace getvariable ['CTI_TABLET_KEY',41])],
...
",(missionNamespace getVariable "CTI_SM_MAX_ACTIVE")],
"
