...
CTI_UI_Respawn_GetTime={
	...
	_target=_this;
	_time=240;
	if (_target in ((CTI_P_SideLogic) getVariable	["cti_structures",[]]) || _target == ((CTI_P_SideJoined) call CTI_CO_FNC_GetSideHQ)) then {_time=(missionNamespace getVariable "CTI_RESPAWN_TIMER")} else{
