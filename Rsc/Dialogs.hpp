...
class CTI_RscInteraction {
	...
	class controls {
		...
		class CTI_Icon_Net : CTI_Icon_Lock {
			idc = 511003;
		...
		class CTI_Icon_Gear : CTI_Icon_Lock {
			idc = 511004;
		...
		class CTI_Icon_Com : CTI_Icon_Lock {
			idc = 511024;
			x = "SafeZoneX + SafeZoneW*0.55";
		...
		class CTI_Icon_Pilot : CTI_Icon_Lock {
			idc = 511025;
			x = "SafeZoneX + SafeZoneW*0.55";
...
class CTI_RscTabletPurchaseMenu {
	...
	class controls {
		...
		class CTI_Icon_Barracks : RscActiveText {
			...
			w = "(3/4*SafeZoneH)*0.615*0.46*(1/7)";
			h = "SafeZoneH * 0.041";
		...
		class CTI_Icon_Light : CTI_Icon_Barracks {
			idc = 110002;
			x = "SafeZoneX + (SafeZoneW - (3/4*SafeZoneH))/2+ (3/4*SafeZoneH) *0.191+(3/4*SafeZoneH)*0.615*0.02+(3/4*SafeZoneH)*0.615*0.46*(1/7.1)*1";
		...
		class CTI_Icon_Heavy : CTI_Icon_Barracks {
			idc = 110003;
			x = "SafeZoneX + (SafeZoneW - (3/4*SafeZoneH))/2+ (3/4*SafeZoneH) *0.191+(3/4*SafeZoneH)*0.615*0.02+(3/4*SafeZoneH)*0.615*0.46*(1/7.1)*2";
		...
		class CTI_Icon_Air : CTI_Icon_Barracks {
			idc = 110004;
			x = "SafeZoneX + (SafeZoneW - (3/4*SafeZoneH))/2+ (3/4*SafeZoneH) *0.191+(3/4*SafeZoneH)*0.615*0.02+(3/4*SafeZoneH)*0.615*0.46*(1/7.1)*3";
		...
		class CTI_Icon_Repair : CTI_Icon_Barracks {
			idc = 110005;
			x = "SafeZoneX + (SafeZoneW - (3/4*SafeZoneH))/2+ (3/4*SafeZoneH) *0.191+(3/4*SafeZoneH)*0.615*0.02+(3/4*SafeZoneH)*0.615*0.46*(1/7.1)*4";
		...
		class CTI_Icon_Ammo : CTI_Icon_Barracks {
			idc = 110006;
			x = "SafeZoneX + (SafeZoneW - (3/4*SafeZoneH))/2+ (3/4*SafeZoneH) *0.191+(3/4*SafeZoneH)*0.615*0.02+(3/4*SafeZoneH)*0.615*0.46*(1/7.1)*5";
		...
		class CTI_Icon_Naval : CTI_Icon_Barracks {
			idc = 110007;
			x = "SafeZoneX + (SafeZoneW - (3/4*SafeZoneH))/2+ (3/4*SafeZoneH) *0.191+(3/4*SafeZoneH)*0.615*0.02+(3/4*SafeZoneH)*0.615*0.46*(1/7.1)*6";
